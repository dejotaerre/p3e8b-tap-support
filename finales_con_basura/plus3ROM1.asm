...
; Formatting message
		...
		IF spanish
m03a7:		DM	"Ya formateado. Tecla A para", $0D
		DM	"abandonar/otra para continuar", 0
		ELSE
...
m05b8:		LD	HL,FLAGS3
		...
		ELSE
		CALL	m2ada
		DB	$0B		; else nonsense in BASIC error
		ENDIF
...
m07df:		CALL	m2b64
		...
		IF spanish
m07c9:		DM	"K LIBRES", $0D, 0
m07d1:		DM	"NINGUN FICHERO ENCONTRADO", $0D, $0D, 0
		ELSE
m07c9:		DM	"K free", $0D, 0
m07d1:		DM	"No files found", $0D, $0D, 0
		ENDIF
		ENDIF
...
m093b:		CALL	m2ada
		DB	$4E		; cause "Invalid drive" error
...
msg18:		DB	$16,0,0,$10,0,$11,$07,$13,0
		...
		ELSE
		DB	$80
m0e42:		DM	"Press REC & PLAY, then any key", $AE
		DM	$0D, "Program:", $A0
		DM	$0D, "Number array:", $A0
		DM	$0D, "Character array:", $A0
		DM	$0D, "Bytes:", $A0
		ENDIF
...
m1515:		CALL	m2b35
		...
		ELSE
msg18:		DM	$16,$00,$00
m14e5:		DM	$10,$00,$11,$07,$13,$00
		IF spanish
		DM	"Introduzca la cinta y pulse PLAY", $0D
		DM	"Cancelar: pulse BREAK dos veces.", $FF
		ELSE
		DM	"Insert tape and press PLAY", $0D
		DM	"To cancel - press BREAK twice", $FF
		ENDIF
		ENDIF
...
m1df7:		CALL	m10b1
		...
		CALL	m2ada
		DB	36		; else error j - invalid baud rate
m1df1:		LD	A,(DE)
...
m1df9:		LD	HL,(CH_ADD)
		LD	A,(HL)
		CP	$3B
		JP	NZ,m1125	; nonsense in BASIC error if next char not $3B
		ENDIF
m1e02:		RST	28H
...
m2427:		CALL	m3f00
		...
		RST	10H		; estado, no imprimo ningún msg tipo "physical
		LD	A,definklin_lw	; drives", no tiene sentido para mi por que
		RST	10H		; es obvio lo que significan las letras
...
m24cc:		CALL	m10b1
		...
		ELSE
		IF spanish
m24be:		DM	"Unidades disponibles:  ", 0
m24c4:		DM	"M", 0
m24c8:		DM	"A y M", 0
m24d4:		DM	"A, B y M", 0
m24e4:		DM	".", 0
...
m24be:		DM	"Drive", 0
m24c4:		DM	" M:", 0
m24c8:		DM	"s A: and M:", 0
m24d4:		DM	"s A:, B: and M:", 0
m24e4:		DM	" available.", 0
		ENDIF
		ENDIF
...
m276d:			DM	"Error en MERG", "E"+$80
m2778:			DM	"FICHERO INCORRECT", "O"+$80
m2787:			DM	"Error en COD", "E"+$80
m2791:			DM	"EXCESO DE PARENTESI", "S"+$80
m27a2:			DM	"YA EXISTE EL FICHER", "O"+$80
m27b5:			DM	"NOMBRE NO VALID", "O"+$80
m27c1:			DM	"NO EXISTE ESE FICHER", "O"+$80
m27d4:			DM	"DIPOSITIVO NO VALID", "O"+$80
m27e2:			DM	"VELOCIDAD NO VALID", "A"+$80
m27f3:			DM	"NOTA NO VALID", "A"+$80
m2804:			DM	"NUMERO MUY GRAND", "E"+$80
m2812:			DM	"NOTA FUERA DE MARGE", "N"+$80
m2823:			DM	"FUERA DE MARGE", "N"+$80
m282f:			DM	"DEMASIADAS NOTA", "S"+$80
m2842:			DM	"NOMBRE INCORRECT", "O"+$80
m284e:			DM	"PARAMETRO INCORRECT", "O"+$80
m285c:			DM	"UNIDAD NO ENCONTRAD", "A"+$80
m286b:			DM	"FICHERO NO ENCONTRAD", "O"+$80
m2879:			DM	"YA EXISTE EL FICHER", "O"+$80
m288c:			DM	"FIN DE FICHER", "O"+$80
m289d:			DM	"DISCO LLEN", "O"+$80
m28a6:			DM	"DIRECTORIO LLEN", "O"+$80
m28b4:			DM	"FICHERO SOLO LECTUR", "A"+$80
m28c5:			DM	"FICHERO NO ABIERT", "O"+$80
m28d2:			DM	"FICHERO YA EN US", "O"+$80
m28e5:			DM	"SINTAXIS INCORRECT", "A"+$80
m28fd:			DM	"FALTA SECCIO", "N"+$80
m290b:			DM	"FALTA CACH", "E"+$80
m2913:			DM	"FICH. DEMASIADO GRAND", "E"+$80
m291f:			DM	"DISCO NO DE ARRANQU", "E"+$80
m2933:			DM	"UNIDAD YA EN US", "O"+$80
m293f:			DM	"UNIDAD NO PREPARAD", "A"+$80
m294e:			DM	"DISCO PROTEGID", "O"+$80
m2965:			DM	"FALLO DE BUSQUED", "A"+$80
m296e:			DM	"ERROR DE DATO", "S"+$80
m297c:			DM	"SIN DATO", "S"+$80
m2983:			DM	"SIN MARCA DIRECCIONE", "S"+$80
m2997:			DM	"FORMATO NO RECONOCID", "O"+$80
m29af:			DM	"ERROR DESCONOCID", "O"+$80
m29c1:			DM	"DISCO CAMBIAD", "O"+$80
m29d6:			DM	"SOPORTE NO ADECUAD", "O"+$80
m29e6:			DM	"ATRIBUTO NO VALID", "O"+$80
m29f7:			DM	"COPIA DE/HACIA CINT", "A"+$80
m2a0f:			DM	"DESTINO POLIVALENT", "E"+$80
m2a29:			DM	"DESTINO NO ES UNIDA", "D"+$80
m2a42:			DM	"UNIDAD B AUSENT", "E"+$80
m2a59:			DM	"+2A NO ADMITE FORMA", "T"+$80
m2a74:			DM	"LA UNIDAD NO ES A NI ", "B"+$80
m2a8a:			DM	"UNIDAD INCORRECT", "A"+$80
m2a97:			DM	"ERROR DE LONGITU", "D"+$80
		ELSE
...
m2a97:			DM	"Code length erro", "r"+$80
		...
		IF garry=0
m2aa8:			DM	"You should never see thi", "s"+$80
m2ac1:			DM	"Hello there !"
		ENDIF
...
m2b09:			EI
			...
			AND	A
			LD	HL,o107F	; test against ROM 3 editing error address
			SBC	HL,DE
...
; Files copied messages
		...
		ELSE
			IF spanish
m3291:				DM	$0D,"  1 fichero copiado.",$0D,$0D,$00
m32a5:				DM	" ficheros copiados.",$0D,$0D,$00
			ELSE
...
m3631:		DB	$21,$41,$61,$81
		...
		DB	$3C,$3D,$FA,$FB
		DB	$FC,$FD,$5E,$7E
		DB	$9E,$BE,$DE,$00	; end of first screen third
		...
		DB	$3B,$3C,$3D,$9A
		DB	$9B,$9C,$FA,$FB
		DB	$FC,$FD,$00	; end of second screen third
