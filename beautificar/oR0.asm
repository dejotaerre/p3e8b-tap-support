...
l02ae   rra
        ...
        ld      a,$02
        rst     $28
        DW      $1601           ; open stream 2 for output
        xor     a
...
l0a4e   ld      a,(process)
        ...
        call    l05a7           ; page in normal memory
        rst     $28
        DW      $196e           ; get address of first line in HL
        rst     $28
        DW      $1695           ; get line number in DE
        call    l05cc           ; page in DOS workspace
...
l0a76   ld      a,(process)
        ...
        call    l05a7           ; page in normal memory
        rst     $28
        DW      $196e           ; get last line address in DE
        ex      de,hl
        rst     $28
        DW      $1695           ; get last line number in DE
        call    l05cc           ; page in DOS workspace
        ld      (E_PPC),de      ; set as current line
        ld      a,$0f
        call    l1ca3           ; set colours to blue ink, white paper
...
l1894   pop     hl              ; restore HL
        ret
l1896   rst     $28
        DW      $10db           ; call key mode change routine
        ret
...
l197b   push    bc              ; save registers
        ...
        push    de
        rst     $28
        DW      $0e9b           ; get HL=address of line B in display file
        ld      bc,$0007
...
l1a95   call    l05a7           ; page in normal memory
        ...
        ld      hl,(RC_STEP)
        rst     $28
        DW      $30a9           ; HL=STEP*number of lines
...
l1ac5   ld      a,(hl)          ; get next character
        rst     $28
        DW      $18b6           ; skip past embedded number if necessary
        cp      $0d
...
l1b50   ld      (STRIP2+$07),bc ; save no of characters before embedded #
        ...
        rst     $28
        DW      $18b6           ; skip past embedded number
...
l1b64   inc     hl              ; HL points to next statement/line
        rst     $28
        DW      $33b4           ; stack the embedded number
        rst     $28
        DW      $2da2           ; get embedded number to BC
        ld      h,b
        ld      l,c             ; HL=embedded line number
        rst     $28
        DW      $196e           ; get HL=address of target line
...
l1bdc   ld      de,(STRIP2+$0f)
        ...
        rst     $28
        DW      $2d2b           ; stack BC on FP stack (HL=address)
        pop     de
        ld      bc,$0005
...
l1c2a   push    bc
        rst     $28
        DW      $19b8           ; find DE=address of next line
        ld      hl,(STRIP2+$0d)
        and     a
        sbc     hl,de
