...
; LA ROM 3 DEL PROY +3E ES BINARIAMENTE IGUAL AL PRODUCTO DE ESTE FUENTE
...
; ---
	...
	IF spanish
		IF v41
			DB        $FF, $FC        ; Five unused locations.
		ELSE
			DB        $FF, $C0        ; Five unused locations.
		ENDIF
	ELSE
		IF v41
			DB        $FF, $15        ; Five unused locations.
		ELSE
...
o1391:  DB        $80
	...
	DM      " FO"
	DB        'R'+$80                                 ; 1
	DM      "VARIABLE NO DEFINID"
	DB        'A'+$80                                 ; 2
	DM      "SUBINDICE INCORRECT"
	DB        'O'+$80                                 ; 3
	DM      "MEMORIA AGOTAD"
	DB        'A'+$80                                 ; 4
	DM      "FUERA DE PANTALL"
	...
	DM      "ARG. INVALID"
	DB        'O'+$80                                 ; A
	DM      "ENTERO EXCEDE MARGE"
	DB        'N'+$80                                 ; B
	DM      "SIN SENTIDO EN BASI"
	DB        'C'+$80                                 ; C
	DM      "BREAK/CONT "
	IF v41
		DM      "REPIT"
	...
	DM      " NEX"
	DB        'T'+$80                                 ; I
	DM      "DISP. E/S INCORRECT"
	DB        'O'+$80                                 ; J
	DM      "COLOR NO VALID"
	DB        'O'+$80                                 ; K
	DM      "PROGR. INTERRUMPID"
	DB        'O'+$80                                 ; L
	DM      "RAMTOP "
	IF v41
		DM      "INCORRECT"
...
o1539:
	...
	DM      "Invalid argumen"
	DB        't'+$80                                 ; A
	DM      "Integer out of rang"
	DB        'e'+$80                                 ; B
	DM      "Nonsense in BASI"
	DB        'C'+$80                                 ; C
	DM      "BREAK - CONT repeat"
	DB        's'+$80                                 ; D
	DM      "Out of DAT"
	DB        'A'+$80                                 ; E
	DM      "Invalid file nam"
	...
	DM      "FOR without NEX"
	DB        'T'+$80                                 ; I
	DM      "Invalid I/O devic"
	DB        'e'+$80                                 ; J
	DM      "Invalid colou"
	DB        'r'+$80                                 ; K
	DM      "BREAK into progra"
	DB        'm'+$80                                 ; L
	DM      "RAMTOP no goo"
	DB        'd'+$80                                 ; M
	DM      "Statement los"
...
SWITCH_ROM2:    LD      SP,tmp_workmem+199 ;NUEVO STACK
		...
		LD      DE,buffer_tapsize
		LD      HL,tmp_buffertap

		CALL    DOS_READ                ;LEO UN "sector"
		DI                              ;+3DOS *SIEMPRE* HABILITA LAS INT CUANDO TERMINA SU
						;SERVICIO
		LD      HL,buffer_tapsize     ; hago de cuenta que lei todos los bytes
		JR      C,SIN_ERROR
...
RESET_FILE:     LD      DE,buffer_tapsize
...
CONT_SET_POS:   LD      B,$06                   
		...
		LD      HL,buffer_tapsize     ; por leer, entonces calculo cuantos bytes se leyeron
		SBC     HL,DE
		
SIN_ERROR:      LD      BC,$7FFD
		LD      A,$17
		OUT     (C),A
		LD      BC,$1ffd
		LD      A,$04
...
SPARE2:         DS      319 - ($-FREE_START2)	;

		DW      $FFFF   ; para los juegos que usen IM2 con I=3F
	
o3C01   	DM      $13, $00, "19", $13, $01, "87"  ; testcard message
							; why is it here???
...
END_LDTAPE:     LD      A,$01           ; EN EL CASO DE APRETAR SPACE MIENTRAS SE CARGA
...
SET_POS_SIG:    PUSH    DE
		...
		JR      NC,NODESB
		INC     (HL)
NODESB:         LD      A,(conf_ram)            ;REESTABLEZCO ROM/RAM
		OUT     (C),A
		POP     HL
		POP     BC
		POP     DE
...
MOVE_NEXT_BLQ:  LD      A,$02           ; mover al bloque siguiente en caso de "error"
		CALL    CALL_OTRAS
		
ERROR_EN_CARGA: CALL    SWP_RTALERT     ; retorno forzado por posible error +3dos
		INC     SP
		INC     SP
		EX      AF,AF'
		AND     A
